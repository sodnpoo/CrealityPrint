...
#include "libslic3r/Feature/SurfaceModifier/SurfaceModifier.hpp"
...
void Layer::make_perimeters()
{
    ...
    // Apply surface-modifier speed zones: split external-perimeter loops at the
    // painted-zone boundaries and flag the inside sub-paths for the G-code speed
    // override. See Feature/SurfaceModifier.
    if (!this->surface_modifier_painted.empty())
        Feature::SurfaceModifier::apply_speed_zones(m_regions, this->surface_modifier_painted);
