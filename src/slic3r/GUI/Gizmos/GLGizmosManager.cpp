...
#include "slic3r/GUI/Gizmos/GLGizmoSurfaceModifier.hpp"
...
void GLGizmosManager::switch_gizmos_icon_filename()
{
    ...
    for (auto& gizmo : m_gizmos) {
        ...
        case(EType::FuzzySkin):
            ...
            break;
        case(EType::SurfaceModifier):
            gizmo->set_icon_filename("custom-gcode_speed.svg");
            break;
...
bool GLGizmosManager::init()
{
    ...
    m_gizmos.emplace_back(new GLGizmoSurfaceModifier(m_parent, "custom-gcode_speed.svg", EType::SurfaceModifier));
...
void GLGizmosManager::update_data()
{
    ...
    if (m_pending_update) {
        ...
        // return; // ������Ǿ�����������������һ��return���ȴ��´�update�ٸ������ݡ�
    }
